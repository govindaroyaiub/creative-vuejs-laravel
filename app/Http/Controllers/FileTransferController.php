...
class FileTransferController extends Controller
{
    ...
    public function uploadFromPreview(Request $request)
    {
        $paramA = $request->query('paramA'); // preview id
        $paramB = $request->query('paramB'); // preview name
        $paramC = $request->query('paramC'); // client name

        return Inertia::render('FileTransfers/UploadFromPreview', [
            'preview_id' => $paramA,
            'preview_name' => $paramB,
            'client_name' => $paramC,
        ]);
    ...
    public function uploadFromPreviewPost(Request $request)
    {
        // Simple validation
        $request->validate([
