...
class CsvGenerator
{
    /** GA4 "Pages and screens: Content group" export for a single site. */
    public static function analytics(array $store, string $siteId = 'f1maximaal', ?string $from = null, ?string $to = null): string
    {
        ...
        $accountName = explode('.', $site['name'])[0];
        ...
        foreach ($days as $d) {
            ...
            $lines[] = $site['name'] . ',' . str_replace('-', '', $d['dateKey']) . ',' .
