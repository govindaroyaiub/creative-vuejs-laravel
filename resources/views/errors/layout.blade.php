...
<head>
    ...
    <title>Error {{ $exception->getStatusCode() }} - Planet Nine</title>
...
<body>
    <div class="error-container">
        <img src="https://www.planetnine.com/logo/planet-nine-logo.png" alt="Planet Nine" class="planet-nine-logo">
