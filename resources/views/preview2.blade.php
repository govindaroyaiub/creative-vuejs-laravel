                ...
                $.each(response.data, function(key, value) {
                    ...
                    row = row + '<div class="banner-creatives banner-area-'+ value.width +'" style="display: inline-block; width: ' + value.width + 'px; margin-right: 10px;">';
                        ...
                        row = row + '<ul style="display: flex; flex-direction: row;" class="previewIcons">';
                            ...
                            row = row + '<li class="banner-options"><a href="/previews/banner/single/edit/' + value.id + '"><i class="fa-solid fa-pen-to-square" style="display: flex; margin-top: 0.5rem; margin-left: 0.5rem; font-size:20px;"></i></a></li>';
                            row = row + '<li class="banner-options"><a href="/previews/banner/single/download/' + value.id + '"><i class="fa-solid fa-download" style="display: flex; margin-top: 0.5rem; margin-left: 0.5rem; font-size:20px;"></i></a></li>';
                            row = row + '<li class="banner-options"><a href="javascript:void(0)" onclick="return confirmDeleteBanner(' + value.id + ')"><i class="fa-solid fa-trash" style="display: flex; margin-top: 0.5rem; margin-left: 0.5rem; font-size:20px;"></i></a></li>';
                        row = row + '@endif';
                        row = row + '</ul>';
                    row = row + '</div>';
                });
