...
import { LayoutDashboard, Paperclip, Clapperboard, MonitorCog, MonitorStop, ReceiptText, Users, History, Image, CircleDollarSign, Paintbrush, ImagePlay } from 'lucide-vue-next';
