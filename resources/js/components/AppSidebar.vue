...
import { LayoutDashboard, Paperclip, Clapperboard, MonitorCog, MonitorStop, ReceiptText, Users, History, Type, FileCode, Handshake, Paintbrush, ImagePlay, ImageMinus, HardDriveIcon } from 'lucide-vue-next';
