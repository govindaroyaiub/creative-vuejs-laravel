    ...
    <AppLayout :breadcrumbs="[{ title: 'Activity Logs', href: '/activity-logs' }]">
        <div
            ...
            <div class="p-6 space-y-6">
                <!-- Search Section -->
                <div
                    class="bg-white dark:bg-black rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 flex w-full items-center gap-2">
                    ...
                    <div
                        class="text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-black px-3 py-4 rounded-2xl w-1/6 text-center">
                ...
                <div v-if="logs?.data?.length > 0" class="space-y-4">
                    <div v-for="(log, index) in logs.data" :key="log.id"
                        class="bg-white dark:bg-black rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 hover:shadow-md transition-all duration-200 overflow-hidden">
                        <div class="p-4">
                            <!-- Header Row -->
                                ...
                                <div v-if="log.properties && log.properties.attributes" class="space-y-3">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div v-for="(value, key) in log.properties.attributes" :key="key"
                                            class="bg-gray-50 dark:bg-gray-950 rounded-lg p-3">
                ...
                <div v-else
                    ...
                    <div
                        class="w-20 h-20 mx-auto bg-gray-100 dark:bg-black rounded-full flex items-center justify-center mb-6">
