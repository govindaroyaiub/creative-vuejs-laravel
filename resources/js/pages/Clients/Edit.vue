            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div>
                    ...
                    <input v-model="form.name" type="text"
                        class="w-full rounded-2xl border px-3 py-2 dark:bg-neutral-800 dark:text-white" required />
                </div>
                ...
                <div>
                    ...
                    <input v-model="form.preview_url" type="url"
                        class="w-full rounded-2xl border px-3 py-2 dark:bg-neutral-800 dark:text-white" />
                </div>
