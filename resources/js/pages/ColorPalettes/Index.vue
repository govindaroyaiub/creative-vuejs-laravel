  ...
  <AppLayout :breadcrumbs="[{ title: 'Color Palettes' }]">
    <div
      ...
      <div class="p-6 space-y-6">
        ...
        <!-- Search Section -->
        <div class="bg-white dark:bg-black rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 flex items-center space-x-4">
        ...
        <div v-if="colorPalettes?.length > 0" class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          <div v-for="(palette, index) in colorPalettes" :key="palette.id"
            ...
            <div class="p-6 pb-4">
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <div class="flex items-center space-x-4 bg-gray-50 dark:bg-gray-900 rounded-lg p-3">
            ...
            <!-- Card Actions -->
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
