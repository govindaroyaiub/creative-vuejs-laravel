      ...
      <div v-if="open" class="fixed inset-0 z-[80] flex items-center justify-center p-4" @click="close">
        ...
        >
          ...
          <header class="flex items-start justify-between gap-3 border-b border-zinc-100 px-6 py-4 dark:border-zinc-800">
            <div>
              <div class="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-zinc-500">
                <FolderPlus class="h-3 w-3" />
                New project
              </div>
              <h3 class="mt-1 text-lg font-semibold text-zinc-900 dark:text-zinc-100">Create a new project</h3>
              <p class="mt-0.5 text-xs text-zinc-500 dark:text-zinc-400">
                A project groups all revisions for one creative deliverable.
              </p>
            </div>
            <button
              type="button"
          ...
          <div class="space-y-5 px-6 py-5">
            ...
            <div>
              ...
              <input
                ...
                v-model="name"
                type="text"
                placeholder="e.g. Holiday Campaign Banners"
