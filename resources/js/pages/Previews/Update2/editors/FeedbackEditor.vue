  ...
  <div class="space-y-6">
    <header class="flex items-start justify-between gap-4">
      <div class="min-w-0 flex-1">
        ...
        <input
          :value="feedback.name"
          class="w-full rounded-xl border px-3 py-2 text-2xl font-semibold uppercase tracking-tight text-[var(--p2-text)] outline-none transition-colors duration-200 ease-p2-expo placeholder:text-[var(--p2-text-subtle)]"
      ...
      <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex gap-2">
          <button
            v-if="feedback.is_approved !== 1"
            type="button"
            class="inline-flex h-9 items-center gap-1.5 rounded-full bg-emerald-600 px-4 text-xs font-semibold text-white shadow-sm transition-all duration-300 ease-p2-expo hover:-translate-y-0.5 hover:bg-emerald-500"
          ...
          <button
            v-else
            type="button"
            class="inline-flex h-9 items-center gap-1.5 rounded-full border border-rose-500/30 bg-rose-500/5 px-4 text-xs font-semibold text-rose-500 transition-colors duration-300 ease-p2-expo hover:border-rose-500/50 hover:bg-rose-500/10"
            @click="disapprove"
          >
