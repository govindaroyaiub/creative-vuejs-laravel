    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <div class="p-4 bg-white dark:bg-black rounded-lg shadow dark:shadow-white">
            ...
            <div class="flex gap-4">
                <div class="bg-white dark:bg-black rounded-lg p-4 shadow w-full dark:shadow-white"
            ...
            <div class="bg-white dark:bg-black rounded-lg p-4 shadow mt-8 dark:shadow-white"
                :style="{ height: `calc(100vh - 350px)` }">
